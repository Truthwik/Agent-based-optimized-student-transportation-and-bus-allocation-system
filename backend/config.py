...
DB_PASSWORD = os.getenv("DB_PASSWORD", "bvrit")
DB_NAME = os.getenv("DB_NAME", "bvrit_transport")

# Prefer the explicit DATABASE_URL from .env; fall back to constructing from parts
